...
<div class="container">
    <div class="row">
      ...
      <p class="text-large">MVP Registration is the easiest way to get paid. Our web app enables
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-offset-1">
            ...
            <p>Are you frustrated by confusing software and complicated processes? MVP
                ...
                want. You'll appreciate the difference right away with a clean modern
                design and a responsive, user-friendly experience.</p>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-5">
