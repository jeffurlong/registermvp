        ...
        <div class="col-md-8 col-offset-2">
            ...
            <ul>
                ...
                <li>We will protect personal information by reasonable security safeguards
                    ...
                    copying, use or modification.</li>
            ...
            (information or software) on MVP Registration's web site for personal,
            ...
            MVP Registration's web site;</li>
            ...
            restrictions and may be terminated by MVP Registration at any time. Upon
            ...
            <h3>3. Disclaimer</h3>
            <ol type="a">
            <li>The materials on MVP Registration's web site are provided "as is". MVP
            Registration makes no warranties, expressed or implied, and hereby
            ...
            violation of rights. Further, MVP Registration does not warrant or make
            ...
            <h3>4. Limitations</h3>
            <p>In no event shall MVP Registration or its suppliers be liable for any damages
            ...
            materials on MVP Registration's Internet site, even if MVP Registration or
            a MVP Registration authorized representative has been notified orally or in
            ...
            <p>The materials appearing on MVP Registration's web site could include
            technical, typographical, or photographic errors. MVP Registration does not
            warrant that any of the materials on its web site are accurate, complete, or
            current. MVP Registration may make changes to the materials contained on its
            web site at any time without notice. MVP Registration does not, however,
            make any commitment to update the materials.</p>
            <h3>6. Links</h3>
            <p>MVP Registration has not reviewed all of the sites linked to its Internet web
            site and is not responsible for the contents of any such linked site. The
            inclusion of any link does not imply endorsement by MVP Registration of the
            site. Use of any such linked web site is at the user's own risk.</p>
            <h3>7. Site Terms of Use Modifications</h3>
            <p>MVP Registration may revise these terms of use for its web site at any time
            without notice. By using this web site you are agreeing to be bound by the
            then current version of these Terms and Conditions of Use.</p>
            <h3>8. Governing Law</h3>
            <p>Any claim relating to MVP Registration's web site shall be governed by the
