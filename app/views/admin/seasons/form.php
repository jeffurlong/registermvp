            ...
            <div class="col-md-10 col-md-offset-1">
                <form id="season-form" method="post">
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="control-label" for="name">Season Name <span class="required">(required)</span></label>
                        ...
                        <div class="col-md-6">
                            <label class="control-label" for="program-id">Program <span class="required">(required)</span></label>
                            <select class="form-control required" id="program-id" name="program_id">
                                ...
                                <?php endforeach; ?>
                                <option id="new-program-option" value="new">+ Add New Program</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                         <label class="control-label" for="wysihtml">Description</label>
                        <textarea class="form-control wysihtml" id="wysihtml" name="description" rows="10" >
        ...
        <?php if ($season->exists): ?>
            ...
            <?php else: ?>
                <div class="blank-slate blank-slate-sm">
                    ...
                    <button class="btn btn-default" type="button" data-toggle="modal" data-target="#add-division-modal">
        ...
        <?php if ($season->exists): ?>
            ...
            <?php else: ?>
                <div class="blank-slate blank-slate-sm">
                    ...
                    <button class="btn btn-default" data-toggle="modal" data-target="#add-question-modal">
